...
export default function PlaceholderPage({ title, description, icon: Icon }: { title: string; description: string; icon: LucideIcon }) {
  return (
    <div className="p-4 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-8 sm:p-12 text-center">
        <div className="h-14 w-14 rounded-2xl bg-gray-800 border border-gray-700 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="mt-5 flex justify-center gap-2">
          ...
          <span className="inline-flex px-2.5 py-1 rounded-full text-xs bg-gray-800 text-gray-400 border border-gray-700">
            Próximamente
          </span>
        </div>
      </div>
